...
def edvisit(subject_id, conn):
    ...
    ed_arrival_date_and_time = "{} {}".format(
        arrival_info.date, arrival_info.time)
    ed_discharge_date_and_time = "{} {}".format(
        discharge_info.date, discharge_info.time)
    ...
    for test_result in influneza_tests:
        ...
        if influenza_lab.check_time(ed_discharge_date_and_time) == True:
            influenza_count += 1
    ...
    for micro_test in micro_tests:
        ...
        if micro_lab.check_time(ed_discharge_date_and_time) == True:
            micro_test_num += 1
            if micro_test_num > 5:
                break
    ...
    for antiviral in ed_antivirals:
        ...
        if antiviral_lab.check_time(ed_discharge_date_and_time) == True:
            ...
            human_readable_data["ED Antiviral #{}".format(
                ed_antiviral_count)] = "{} {}".format(
                med_name, med_route)
            machine_data['as_edenroll_fluav{}_name'.format(
                ed_antiviral_count)] = med_name
            machine_data['as_edenroll_fluav{}route'.format(
                ed_antiviral_count)] = med_route
            machine_data['as_edenroll_fluav{}date'.format(
                ed_antiviral_count)] = order_date
            machine_data['as_edenroll_fluav{}time'.format(
    ...
    for antiviral in discharge_antivirals:
        ...
        if dc_antiviral_lab.check_time(ed_discharge_date_and_time) == True:
            ...
            human_readable_data[
                ...
                med_name, med_route)
            machine_data['as_edenroll_fluavdisc{}'.format(
    ...
    for antibiotic in ed_antibiotics:
        ...
        if abx_med.check_time(ed_discharge_date_and_time) == True:            
            ...
            human_readable_data["ED Antibiotics #{}".format(
                    ed_antibiotics_count)] = "{} {} {} {}".format(
                    med_name, med_route, order_date, order_time)
            machine_data['as_edenroll_ab_ed{}_name'.format(
                    ed_antibiotics_count)] = med_name
            machine_data['as_edenroll_ab_ed{}date'.format(
                    ed_antibiotics_count)] = order_date
            machine_data['as_edenroll_ab_ed{}time'.format(
                    ed_antibiotics_count)] = order_time
            machine_data['as_edenroll_ab_ed{}route'.format(
    ...
    for antibiotic in discharge_antibiotics:
        ...
        if dc_abx_med.check_time(ed_discharge_date_and_time) == True:
